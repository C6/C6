...
{
    /// <summary>
    ///     Provides helper methods for writing tests that assert precondition violations.
    /// </summary>
    public static class Violates
    {
        ...
        /// </summary>
        /// <value>
        ///     <see cref="Throws.TypeOf"/> with a
        ///     <see cref="PreconditionException"/>.
        /// </value>
        /// <remarks>
        ///     Allows a precondition violation to be asserted using
        ///     <c>
        ///         Assert.That(code, Violates.Precondition)
        ///     </c>.
        /// </remarks>
        /// <remarks>
        ///     Allows a precondition violation to be asserted:
        ///     <code>Assert.That(code, Violates.Precondition);</code>
        /// </remarks>
        ...
        /// <remarks>
        ///     Allows a precondition violation to be asserted:
        ///     <code>Assert.That(code, Violates.PreconditionSaying("Argument must be non-null"));</code>
        /// </remarks>
        ...
        /// <summary>
        ///     Returns an <see cref="EqualConstraint"/> that checks if a typed precondition was violated.
        /// </summary>
        /// <remarks>
        ///     Allows a precondition violation to be asserted using
        ...
        /// <returns>
        ///     A <seealso cref="Throws.Nothing"/> constraint.
        /// </returns>
        /// <remarks>
        ///     This should only be used as
        ///     <c>
        ///         Assert.That(code, Does.Not.ViolatePrecondition())
        ///     </c>.
        /// </remarks>
