...
namespace C6
{
    public static class SequencedEqualityComparer
    {
        ...
        /// <param name="items">The sequence whose hash code should be computed.</param>
        ...
        /// <returns>The sequenced hash code of the sequence.</returns>
        [Pure]
        ...
        /// <summary>
        /// Compares the items in the two sequences with each other 
        /// with regards to multiplicities and order.
        /// </summary>
        /// <typeparam name="T">The type of the items in the sequence.</typeparam>
        /// <param name="first">The sequence to compare the second
        /// sequence to.</param>
        /// <param name="second">The sequence to compare the first
        /// sequence to.</param>
        /// <param name="equalityComparer">The <see cref="SCG.IEqualityComparer{T}"/>
        /// used to comparer the items in the sequences, or <c>null</c> to use
        /// the default equality comparer <see cref="SCG.EqualityComparer{T}.Default"/>.
        /// The sequences' own equality comparers are completely disregarded.
        /// </param>
        /// <returns><c>true</c> if the sequences contain equal items;
