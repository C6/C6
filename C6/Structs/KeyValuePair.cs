...
namespace C6
{
    ...
    public struct KeyValuePair<TKey, TValue> : IEquatable<KeyValuePair<TKey, TValue>>, IShowable
    {
        ...
        /// Gets the key in the key/value pair.
        /// </summary>
        /// <value>The value in the key/value pair.</value>
        [Pure]
        ...
        /// <see cref="KeyValuePair{TKey,TValue}"/> structure with the
        /// specified key.
        /// </summary>
        ...
        /// <see cref="KeyValuePair{TKey,TValue}"/>, using the string
        /// representations of the key and value.
        /// </summary>
        /// <returns>A string representation of the 
        /// <see cref="KeyValuePair{TKey,TValue}"/>.</returns>
        [Pure]
        ...
        /// are the same type and represent the same value;
        ...
        /// <summary>
        /// Indicates whether the current key-value pair is equal to the 
        /// specified key-value pair.
        /// </summary>
        /// <param name="other">The specified key-value pair to compare with
        /// this key-value pair.</param>
        ...
        /// <returns><c>true</c> if the two key-value pairs are equal;
        /// otherwise, <c>false</c>.</returns>
        [Pure]
        ...
        /// <summary>
        /// Indicates whether the two key-value pair are not equal to each
        /// other.
        /// </summary>
        /// <param name="left">The left key-value pair.</param>
        /// <param name="right">The right key-value pair.</param>
        /// <returns><c>true</c> if the two key-value pairs are not equal;
        /// otherwise, <c>false</c>.</returns>
        [Pure]
        public static bool operator !=(KeyValuePair<TKey, TValue> left, KeyValuePair<TKey, TValue> right) => !left.Equals(right);
